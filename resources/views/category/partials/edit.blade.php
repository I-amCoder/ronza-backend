     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <form id="edit-category-from" method="POST" enctype="multipart/form-data">
                     @csrf
                     @method('PUT')
                     <div class="row">
                         <div class="col-12">
                             <label for="title" class="form-label">Category Name</label>
                             <input type="text" id="editCatName" class="form-control" name="name"
                                 placeholder="Category name...">
                         </div>

                         <div class="col-12 mt-3">
                             <label for="title" class="form-label">Category Title</label>
                             <input type="text" id="editCatTitle" class="form-control" name="title"
                             ...
                             <div class="text-center">
                                 <div class="fileinput fileinput-new" data-provides="fileinput">
                                     <div class="fileinput-preview img-thumbnail" data-trigger="fileinput"
                                         style="width: 200px;">
                                         <img id="editImage" alt="edit Image">
                                     </div>
                                     <div>
             ...
             <div class="modal-footer">
                 ...
                 <button class="btn btn-primary"
                     onclick="document.getElementById('edit-category-from').submit()">Save</button>
             </div>
         </div>
     </div>
 </div>
