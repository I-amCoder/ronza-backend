...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    @if (Session::has('message'))
                        <div class="alert alert-{{ Session::get('message')['type'] }} alert-dismissible fade show"
                            role="alert">
    ...
    <script src="{{ asset('dashboard-theme') }}/vendor/jquery/jquery.min.js"></script>
    <script src="{{ asset('dashboard-theme') }}/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
